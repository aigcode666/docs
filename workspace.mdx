...
- **Domain Setup**: Bind custom domains, or configure your free platform subdomain.
...
If you bind multiple domains to a single project, you can designate one as the **Primary Domain** in the Publish Project settings. All traffic from other alias domains will automatically 301 redirect to your Primary Domain.
